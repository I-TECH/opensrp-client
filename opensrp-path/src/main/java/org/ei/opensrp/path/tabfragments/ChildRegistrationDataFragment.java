...
public class ChildRegistrationDataFragment extends Fragment {
    ...
    public void loadData() {
        if (layout != null && container != null && inflater != null) {
            ...
            layout.addView(wd.createTableRow(inflater, container, "County", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "stateProvince", true)))));
            layout.addView(wd.createTableRow(inflater, container, "Sub County", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "countyDistrict", true)))));
            layout.addView(wd.createTableRow(inflater, container, "Ward", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "cityVillage", true)))));
            ...
            layout.addView(wd.createTableRow(inflater, container, "Sub Location", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "address4", true)))));
            layout.addView(wd.createTableRow(inflater, container, "Village", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "address3", true)))));
            layout.addView(wd.createTableRow(inflater, container, "Landmark", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "address2", true)))));
            layout.addView(wd.createTableRow(inflater, container, "Address", JsonFormUtils.getOpenMrsReadableName(JsonFormUtils.getOpenMrsLocationName(Context.getInstance(), Utils.getValue(detailsMap, "address1", true)))));
